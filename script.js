const imagemVisualizao = document.getElementById("imagem-visualizacao");
...
function trocarTamanho() {
  const idTamanhoSelecionado = document.querySelector(
  ...
  if (opcoesTamanho[tamanhoSelecionado] === "41 mm") {
    imagemVisualizao.classList.add("caixa-pequena");
  } else {
    imagemVisualizao.classList.remove("caixa-pequena");
  }
}
